...
def CMF_MRP(log10_Mmedian_Msun,log10_phimedian,alpha,beta):
    ...
    def CMF_MRP_result(log10_M_Msun) :
        ...
        result = HMF(log10_M_Msun) * (1/0.85) # On considère que la masse d'un amas de galaxie provient à 85% de la matière noire (le reste étant 10% de gaz ICM et 5% de galaxies)
        return result
